...
import com.chomedicine.jindani.models.Questions;
import com.chomedicine.jindani.adapter.AdapterChatBot;
...
public class ChatActivity extends AppCompatActivity {
    ...
    private void finishChat() {
        ...
        adapterChatBot.addChatToList(new ChatModel("낭만AI 닥터초를 이용해주셔서 감사합니다", true));
